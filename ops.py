...
import logs.ops
from action.evaluate import evaluate_row, evaluate_action, evaluate_action_canvas
...
import post_to_canvas_api
from action.post_to_canvas_api import post_to_canvas_api
import html2text
...
def send_messages(user,
    ...
    if send_to_canvas:
		...
		# send a plain text copy to canvas inbox
            ...
            p.set_payload(True,'','',recipients_list,msg_subject,html2text.html2text(msg_body))
